    ...
    <div id="bigData" class="container-fuild">
      <div class="row bigData-container">
        <div class="col-xs-12 col-sm-12 col-md-6 wow zoomIn">
          <img class="img-responsive" src="@/assets/img/img1.png" alt="社团简介">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          <h2 class="bigData-title">
            武汉理工大学·电子商务协会
            <small>/ WHUT Electronic Commerce Association</small>
          </h2>
          <p>武汉理工大学电子商务协会是2008年初发起创办的，协会创建的目的旨在培养同学之间的团队精神，整合我校现有资源，在校园里开展电子商务活动，宣传电子商务知识，锻炼和提高同学们电脑操作、商务软件平台应用、商务谈判、公关策划、组织管理协调能力，让喜欢网上买卖的同学都能参与实际的操作，让热爱网站建设的同学都能学到网站建设的相关知识及事例。协会现任会长：张洁 会长助理：李佳明。</p>
          <p>用科技沟通你我，营造校园里学习电子商务应用及技术开发的良好氛围，活跃电子商务活动的实践气氛，帮助对电子商务感兴趣的学生掌握理论知识，增强实践创新能力。以国外电子商务理论为基础，探索中国特色的电子商务道路，培养电子商务人才，加强本校学生在网络时代的竞争力，引领信息时代新潮流。</p>
          <h2 class="bigData-device">培养学生兴趣爱好 丰富校园生活 &nbsp; 期待你的加入~</h2>
...
<!--        <h3>7x24小时提供出色的IT服务</h3>-->
    ...
    <div id="customer" class="container-fuild">
      <div class="container customer-container">
        <p class="customer-title text-center">社团风采</p>
      ...
      swiperList: [
        {
          ...
          path: "",
          title: '武汉理工大学·电子商务协会',
          content: 'WHUT Electronic Commerce Association',
        },
        {
